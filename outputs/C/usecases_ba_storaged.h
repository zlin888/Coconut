...
array_number_t TOP_LEVEL_usecases_ba_rodrigues_rotate_point_dps(storage_t stgVar680, array_number_t rot_dps, array_number_t x_dps, card_t rot_shp, card_t x_shp)
{
	...
	if ((sqtheta_dps) != (0))
	{
		...
		array_number_t macroDef807;
		array_number_t w_dps = TOP_LEVEL_linalg_mult_by_scalar_dps(stgVar687, rot_dps, theta_inv_dps, rot_shp, 0);
		...
		array_number_t macroDef806;
		array_number_t w_cross_X_dps = TOP_LEVEL_linalg_cross_dps(stgVar690, w_dps, x_dps, w_shp, x_shp);
		card_t tmp_shp = 0;
		...
		array_number_t macroDef805;
		array_number_t v1_dps = TOP_LEVEL_linalg_mult_by_scalar_dps(stgVar696, x_dps, costheta_dps, x_shp, 0);
		...
		array_number_t macroDef804;
		array_number_t v2_dps = TOP_LEVEL_linalg_mult_by_scalar_dps(stgVar699, w_cross_X_dps, sintheta_dps, w_cross_X_shp, 0);
		card_t size811 = width_card_t(TOP_LEVEL_linalg_mult_by_scalar_shp(w_shp, 0));
		array_number_t stgVar703 = storage_alloc(size811);
		array_number_t macroDef803;
		card_t size810 = width_card_t(TOP_LEVEL_linalg_vectorAdd_shp(v1_shp, v2_shp));
...
array_number_t TOP_LEVEL_usecases_ba_project_dps(storage_t stgVar817, array_number_t cam_dps, array_number_t x_dps, card_t cam_shp, card_t x_shp)
{
	...
	card_t size923 = width_card_t(TOP_LEVEL_linalg_vectorSub_shp(x_shp, TOP_LEVEL_linalg_vectorSlice_shp(3, 0, cam_shp)));
	array_number_t stgVar826 = storage_alloc(size923);
	array_number_t macroDef913;
	card_t size922 = width_card_t(TOP_LEVEL_linalg_vectorSlice_shp(3, 0, cam_shp));
	array_number_t stgVar825 = storage_alloc(size922);
	array_number_t macroDef912;
	card_t size921 = width_card_t(TOP_LEVEL_linalg_vectorSlice_shp(3, 0, cam_shp));
	...
	array_number_t macroDef919;
	card_t size926 = width_card_t(TOP_LEVEL_linalg_mult_by_scalar_shp(TOP_LEVEL_linalg_vectorSlice_shp(2, 0, Xcam_shp), 0));
	array_number_t stgVar837 = storage_alloc(size926);
	array_number_t macroDef916;
	card_t size925 = width_card_t(TOP_LEVEL_linalg_vectorSlice_shp(2, 0, cam_shp));
	array_number_t stgVar836 = storage_alloc(size925);
	array_number_t macroDef915;
	card_t size924 = width_card_t(TOP_LEVEL_linalg_vectorSlice_shp(2, 0, Xcam_shp));
	...
	array_number_t macroDef918;
	card_t size927 = width_card_t(TOP_LEVEL_linalg_vectorSlice_shp(2, 0, cam_shp));
...
array_number_t TOP_LEVEL_usecases_ba_compute_reproj_err_dps(storage_t stgVar931, array_number_t cam_dps, array_number_t x_dps, number_t w_dps, array_number_t feat_dps, card_t cam_shp, card_t x_shp, card_t w_shp, card_t feat_shp)
{
	...
	array_number_t macroDef939;
	card_t size940 = width_card_t(TOP_LEVEL_usecases_ba_project_shp(cam_shp, x_shp));
...
{
	env_t_951 env_t_951_value = make_empty_env();
	closure_t closure950 = make_closure(lambda951, &env_t_951_value);
...
{
	env_t_958 env_t_958_value = make_empty_env();
	closure_t closure954 = make_closure(lambda958, &env_t_958_value);
	env_t_959 env_t_959_value = make_empty_env();
	closure_t closure957 = make_closure(lambda959, &env_t_959_value);
...
{
	env_t_995 env_t_995_value = make_env_t_995(x_shp, feat_shp, cams_shp);
	closure_t closure994 = make_closure(lambda995, &env_t_995_value);
...
value_t lambda1022(env_t_1022 *env1012, storage_t stgVar970, number_t i_dps, card_t i_shp)
{
	...
	array_number_t macroDef1002;
	card_t size1026 = width_card_t(x_shp1011.elem);
	array_number_t stgVar972 = storage_alloc(size1026);
	array_number_t macroDef1001;
	card_t size1025 = width_card_t(cams_shp1004.elem);
	array_number_t stgVar971 = storage_alloc(size1025);
	array_number_t macroDef1000;
	card_t size1023 = width_card_t(obs_shp1008.elem);
...
array_array_number_t TOP_LEVEL_usecases_ba_reproj_err_dps(storage_t stgVar960, array_array_number_t cams_dps, array_array_number_t x_dps, array_number_t w_dps, array_array_number_t obs_dps, array_array_number_t feat_dps, matrix_shape_t cams_shp, matrix_shape_t x_shp, card_t w_shp, matrix_shape_t obs_shp, matrix_shape_t feat_shp)
{
	...
	array_array_number_t macroDef1021;
	array_number_t range_dps = TOP_LEVEL_linalg_vectorRange_dps(stgVar965, 0, (p_dps) - (1), 0, (p_shp) - (1));
	env_t_1022 env_t_1022_value = make_env_t_1022(x_shp, x_dps, w_dps, obs_shp, obs_dps, feat_shp, feat_dps, cams_shp, cams_dps);
	closure_t closure1014 = make_closure(lambda1022, &env_t_1022_value);
	env_t_1028 env_t_1028_value = make_env_t_1028(x_shp, feat_shp, cams_shp);
	closure_t closure1020 = make_closure(lambda1028, &env_t_1028_value);
...
value_t lambda1159(env_t_1159 *env1132, storage_t stgVar1075, number_t acc_dps, number_t cur_dps, card_t acc_shp, card_t cur_shp)
{
	...
	number_t macroDef1121;
	array_array_number_t x_dps0 = TOP_LEVEL_usecases_ba_reproj_err_dps(stgVar1076, cam_dps1122, x_dps1130, w_dps1128, obs_dps1126, feat_dps1124, cam_shp1123, x_shp1131, w_shp1129, obs_shp1127, feat_shp1125);
...
void TOP_LEVEL_usecases_ba_run_ba_from_file_dps(storage_t stgVar1030, string_t fn_dps, card_t n_dps, card_t m_dps, card_t p_dps, card_t fn_shp, card_t n_shp, card_t m_shp, card_t p_shp)
{
	...
	env_t_1148 env_t_1148_value = make_env_t_1148(one_cam_shp);
	closure_t closure1085 = make_closure(lambda1148, &env_t_1148_value);
	...
	env_t_1149 env_t_1149_value = make_env_t_1149(one_x_shp);
	closure_t closure1090 = make_closure(lambda1149, &env_t_1149_value);
	...
	env_t_1150 env_t_1150_value = make_empty_env();
	closure_t closure1094 = make_closure(lambda1150, &env_t_1150_value);
	...
	array_number_t macroDef1102;
	env_t_1151 env_t_1151_value = make_env_t_1151(one_w_dps);
	closure_t closure1098 = make_closure(lambda1151, &env_t_1151_value);
	env_t_1152 env_t_1152_value = make_empty_env();
	closure_t closure1101 = make_closure(lambda1152, &env_t_1152_value);
	...
	env_t_1154 env_t_1154_value = make_env_t_1154(one_feat_shp);
	closure_t closure1106 = make_closure(lambda1154, &env_t_1154_value);
	...
	array_array_number_t macroDef1115;
	env_t_1155 env_t_1155_value = make_env_t_1155(one_feat_dps);
	closure_t closure1110 = make_closure(lambda1155, &env_t_1155_value);
	env_t_1156 env_t_1156_value = make_env_t_1156(one_feat_shp);
	closure_t closure1114 = make_closure(lambda1156, &env_t_1156_value);
	...
	env_t_1158 env_t_1158_value = make_empty_env();
	closure_t closure1118 = make_closure(lambda1158, &env_t_1158_value);
	...
	card_t tmp_shp = 0;
	env_t_1159 env_t_1159_value = make_env_t_1159(x_shp, x_dps, w_shp, w_dps, obs_shp, obs_dps, feat_shp, feat_dps, cam_shp, cam_dps);
	closure_t closure1134 = make_closure(lambda1159, &env_t_1159_value);
	env_t_1161 env_t_1161_value = make_empty_env();
	closure_t closure1137 = make_closure(lambda1161, &env_t_1161_value);
